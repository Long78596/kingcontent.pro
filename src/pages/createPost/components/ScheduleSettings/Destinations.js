...
const Destinations = (props) => {
  ...
  const [isShowFanpages, setIsShowFanpages] = useState(true);
      ...
      {listDestinations && listDestinations.length === 0 ? (
        ...
        <Fragment>
          ...
          <div className="listFanpages m-2 overflow-hidden">
            ...
            >
              <h4 className="uppercase">Chọn nơi đăng bài</h4>
              {isShowFanpages ? (
          ...
          {/* hide group part
          <div className="listGroups m-2 overflow-hidden">
            <div
              className="title p-3 font-bold text-base uppercase mb-2 cursor-pointer border rounded-md flex items-center"
              onClick={() => onClickShowGroups()}
            >
              <h4>CHỌN GROUP</h4>
              {isShowGroups ? (
                <FaAngleUp className="ml-auto" />
            ...
            >
              ...
              <div className="listDestinations max-h-52 gap-3 grid grid-cols-2">
                {filteredGroups &&
